...
class RoomShapeViewController: UIViewController {
  ...
  func allowedCorner( index: Int, angle: Angle) -> Bool {
    ...
    d.c(m: "index = \(index)", f: #file, fu: #function, l: #line)
    
    let currentPoint = index2Point[index]
    d.c(m: "currentPoint = \(currentPoint)", f: #file, fu: #function, l: #line)
    switch angle {
    case .Normal:
      cellE = toggle[ (currentPoint.x + 1) + ((currentPoint.y + 0) * 7)]
      d.c(m: "cellE = \(cellE)", f: #file, fu: #function, l: #line)
      
      cellSE = toggle[ (currentPoint.x + 1) + ((currentPoint.y + 1) * 7)]
      d.c(m: "cellSE = \(cellSE)", f: #file, fu: #function, l: #line)
      
      cellS = toggle[ (currentPoint.x + 0) + ((currentPoint.y + 1) * 7)]
      d.c(m: "cellS = \(cellS)", f: #file, fu: #function, l: #line)
    case .Right:
    ...
    sum += cellSE ? 2 : 0
    sum += cellS ? 4: 0
    d.c(m: "sum = \(sum)", f: #file, fu: #function, l: #line)
    
    
    let currentcell = toggle[index]
    d.c(m: "currentcell = \(currentcell)", f: #file, fu: #function, l: #line)
    
    let allowedToggle = currentcell ? removeFrame4[sum] : addFrame4[sum]
    d.c(m: "allowedToggle = \(allowedToggle)", f: #file, fu: #function, l: #line)
  ...
  func allowedSide( index: Int, angle: Angle) -> Bool {
    ...
    let allowedToggle = currentcell ? removeFrame6[sum] : addFrame6[sum]
    d.c(m: "allowedToggle = \(allowedToggle)", f: #file, fu: #function, l: #line)
  ...
  func processCell( index: Int) -> Bool {
    ...
    case 7,14,21,28,35:                                                             return allowedSide(  index: index, angle: .Right)
